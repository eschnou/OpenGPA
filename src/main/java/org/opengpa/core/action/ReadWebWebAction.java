...
@Component
@ConditionalOnProperty(prefix="opengpa.actions", name="read_web", havingValue = "true", matchIfMissing = true)
public class ReadWebWebAction extends BrowseWebAction {
    ...
    public ReadWebWebAction(WebClient webClient) {
        super(webClient);
    }
